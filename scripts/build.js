...
// Nav, footer, and scripts come from the shared module (single source of truth)
const { renderNav, renderFooter: _renderFooter, renderScripts } = require('./shared-templates');

// Wrap renderFooter to pass the office object automatically
function renderFooter() {
  return _renderFooter(office);
}
