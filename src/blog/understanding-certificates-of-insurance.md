---
title: Understanding Certificates of Insurance for Business Owners
slug: understanding-certificates-of-insurance
...
- [General liability](/commercial/general-liability.html) with per-occurrence and general aggregate limits
- [Commercial auto](/personal/auto.html) with combined single limits or split limits
- Umbrella/excess liability with per-occurrence and aggregate limits
- Workers compensation with statutory limits
- Professional liability or other specialty coverage
...
People ask for certificates of insurance because they want to verify that you will not create an uninsured liability for them. Here are the most common situations:

**General contractors hiring subcontractors.** Before a GC lets you on a job site, they need to know you have [general liability](/blog/general-liability-foundation-business-coverage.html) and workers comp. If one of your employees gets hurt or you damage something on the site, your insurance should respond first, not the GC's.
...
1. **Contact your agent.** Tell them who needs the certificate, what coverage they want to see, and whether they need additional insured status or a waiver of subrogation.
2. **Provide the certificate holder's information.** You need their legal name and mailing address exactly as they want it to appear.
3. **Share any specific requirements.** Some clients or landlords have detailed insurance requirements, specific limits, specific endorsements, or specific language in the description of operations. Share these requirements with your agent so the certificate is right the first time.
...
At our agency, we handle COI requests regularly for our [commercial clients](/commercial/general-liability.html). It is one of the most common day-to-day tasks in commercial insurance, and we aim to turn them around quickly so you can get to work.
...
### FAQ: What is a certificate of insurance?
...
### FAQ: What does it mean to be named as an additional insured?
...
### FAQ: How long does it take to get a certificate of insurance?
...
### FAQ: Does a certificate of insurance cost anything?
